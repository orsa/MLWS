...
public class CampaignBidder {
	...
	*/
	...
	public double getBid(tau.tac.adx.agents.oos.CampaignData newCampaign){
		...
		double reach = newCampaign.getReachImps();
		double duration = newCampaign.getDayEnd() - newCampaign.getDayStart() +1;
		double targetAudienceScore = getAudienceScore(newCampaign.getTargetSegment());
